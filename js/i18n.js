...
const translations = {
  ar: {
    ...
    notif_email_rate_limited: "تم إرسال رسائل كثيرة لهذا البريد. انتظر قليلا ثم حاول مرة أخرى.",
  ...
  en: {
    ...
    notif_email_rate_limited: "Too many emails were sent to this address. Wait a while, then try again.",
