...
const translations = {
  ar: {
    ...
    order_cancel: "إلغاء",
    order_success_title: "تم تأكيد طلبك!",
    order_success_msg: "شكراً لك! سيتم التواصل معك قريباً لتأكيد الطلب.",
    ...
    notif_order_placed: "تم تأكيد طلبك بنجاح!",
    ...
    notif_login_email_not_confirmed: "الحساب موجود لكن البريد غير مؤكد. أرسلنا لك رابط التأكيد مرة أخرى.",
  ...
  en: {
    ...
    order_success_msg: "Thank you! We will contact you soon to confirm your order.",
    ...
    notif_order_placed: "Your order has been confirmed!",
    ...
    notif_login_email_not_confirmed: "This account exists but the email is not confirmed. We sent the confirmation link again.",
